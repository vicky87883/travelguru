...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
    ...
    <body class="white">
        ...
        <div id="promo" class="section white"> 
            <div class="container"> 
                <div class="content center">
                    ...
                    <h6>Take a look at the most exclusive & most visited locations in the world - hand-picked just for you.<br> Start traveling the world today!</h6>
                        ...
                        <section class="promo-slider slider">
                            ...
                            <div class="promo-item">
                                <a href="promo-detail.php" class="link-item">
                                    ...
                                    <div class="promo gold">
                                        <span class="t-white">-30%</span>
                                    </div>
                                    <div class="title">
                                        <h5 class="t-gold">GREECE</h5>
                                        <span class="line"></span>
                                        <h3 class="t-white">Visit Mikonos</h3>
                                    </div>
                                </a>
                                <div class="image"><div class="hover"></div><img src="assets/img/promo/mikonos.jpg" alt="Exodus" class="img-fluid"></div>
                            </div>
                            ...
                            <div class="promo-item">
                                <a href="promo-detail.php" class="link-item">
                                    ...
                                    <div class="title">
                                        <h5 class="t-gold">VENEZUELA</h5>
                                        <span class="line"></span>
                                        <h3 class="t-white">Venezuela</h3>
                                    </div>
                                </a>
                            ...
                            <div class="promo-item">
                                <a href="promo-detail.php" class="link-item">
                                    ...
                                    <div class="title">
                                        <h5 class="t-gold">ITALY - ROME</h5>
                                        <span class="line"></span>
                                        <h3 class="t-white">Eternal City</h3>
                                    </div>
                                </a>
                            ...
                            <div class="promo-item">
                                <a href="promo-detail.php" class="link-item">
                                    ...
                                    <div class="title">
                                        <h5 class="t-gold">AUSTRALIA</h5>
                                        <span class="line"></span>
                                        <h3 class="t-white">Australia</h3>
                                    </div>
                                </a>
                                <div class="image"><div class="hover"></div><img src="assets/img/promo/autralia.jpg" alt="Exodus" class="img-fluid"></div>
                            </div>
                            ...
                            <div class="promo-item">
                                <a href="promo-detail.php" class="link-item">
                                    ...
                                    <div class="title">
                                        <h5 class="t-gold">SCOTLAND</h5>
                                        <span class="line"></span>
                                        <h3 class="t-white">Misty Mountains</h3>
                                    </div>
                                </a>
                                <div class="image"><div class="hover"></div><img src="assets/img/promo/scotland.jpg" alt="Exodus" class="img-fluid"></div>
                            </div>
                            ...
                            <div class="promo-item">
                                <a href="promo-detail.php" class="link-item">
                                    ...
                                    <div class="promo gold">
                                        <span class="t-white">-15%</span>
                                    </div>
                                    <div class="title">
                                        <h5 class="t-gold">ITALY</h5>
                                        <span class="line"></span>
                                        <h3 class="t-white">Weekend in Positano</h3>
                                    </div>
                                </a>
                                <div class="image"><div class="hover"></div><img src="assets/img/promo/positano.jpg" alt="Exodus" class="img-fluid"></div>
                            </div>
                            ...
                            <div class="promo-item">
                                <a href="promo-detail.php" class="link-item">
                                    ...
                                    <div class="title">
                                        <h5 class="t-gold">USA - NEW YORK</h5>
                                        <span class="line"></span>
                                        <h3 class="t-white">New York</h3>
                                    </div>
                                </a>
                                <div class="image"><div class="hover"></div><img src="assets/img/promo/newyork.jpg" alt="Exodus" class="img-fluid"></div>
                            </div>
                            ...
                            <div class="promo-item">
                                <a href="promo-detail.php" class="link-item">
                                    ...
                                    <div class="title">
                                        <h5 class="t-gold">MOROCCO</h5>
                                        <span class="line"></span>
                                        <h3 class="t-white">Morocco Colors</h3>
                                    </div>
                                </a>
        ...
        <div id="about" class="section video"> 
                <div class="container"> 
                    <div class="content center">
                        <h5 class="t-white">THE AGENCY</h5>
                        <span class="line gold"></span>
        ...
        <div class="section white"> 
            <div class="container" id="posts"> 
                <div class="content center">
                    ...
                    <span class="line gold"></span>
                    <h2 class="t-black">Latest from the <span class="t-gold">Blog</span></h2>
                    <div class="row text-justify mt-50">
        ...
        <!-- Section -->
        <div id="testimonial" class="section white "> 
            <div class="container center"> 
                <h5 class="t-black">TESTIMONIALS</h5>
                <span class="line gold"></span>
                <h2 class="t-black">Our <span class="t-gold">clients</span> say:</h2>
                
                <!-- TESTIMONIALS -->
                <div class="testimonial-container">
                    <div id="t-item" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            <li data-target="#t-item" data-slide-to="0" class="active gold"></li>
                            <li data-target="#t-item" data-slide-to="1" class="gold"></li>
                            <li data-target="#t-item" data-slide-to="2" class="gold"></li>
                        </ol>
                        <div class="carousel-inner content">
                            ...
                            <div class="carousel-item active"> 
                                <div class="item">  
                                    <div class="img center"><img src="assets/img/user2.jpg" alt="Exodus" class="img-fluid"></div>
                                    <h6 class="text t-black">A must-have template. Maybe one of the best vintage templates so far in the market. Recommended 100%.</h6>
                                    <div class="name t-black">MARIA De ANDRE'</div>
                                    <div class="role t-dark-clay">Artist</div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item"> 
                                <div class="item">
                                    <div class="img center"><img src="assets/img/user1.jpg" alt="Exodus" class="img-fluid"></div>
                                    <h6 class="text t-black">Extremelly flexible and easy to use. Code is clean and all files well organized. Great job guys.</h6>
                                    <div class="name t-black">JOHN E. PERRY</div>
                                    <div class="role t-dark-clay">Moravian Ltd - CEO</div>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item"> 
                                <div class="item ">
                                    <div class="img center"><img src="assets/img/user3.jpg" alt="Exodus" class="img-fluid"></div>
                                    <h6 class="text t-black">Fast, easy, reliable, fun, flexible, modern. Many options, colors, widgets. +++</h6>
                                    <div class="name t-black">LINDA FALANGY</div>
                                    <div class="role t-dark-clay">Graphic Designer</div>
                                </div>
                            </div>
                        </div>
                    </div>
